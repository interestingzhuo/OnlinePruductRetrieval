...
def basic_training_parameters(parser):
    ...
    parser.add_argument('--dataset',              default='eBayProduct',   type=str,   help='Dataset to use. Currently supported: cub200, cars196, online_products.')
    ...
    parser.add_argument('--loss',            default='cross',      type=str,   help='Training criteria: For supported methods, please check criteria/__init__.py')
    ...
    parser.add_argument('--embed_dim',        default=2048,         type=int,                    help='Embedding dimensionality of the network. Note: dim = 64, 128 or 512 is used in most papers, depending on the architecture.')
...
def loss_specific_parameters(parser):
    ...
    parser.add_argument('--loss_triplet_margin',       default=0.85,         type=float, help='Margin for Triplet Loss')
    ...
    ##relaxation
    parser.add_argument('--relax',             default='ori',  type=str, help='relaxation type.')
...
def origin_parameters(parser):
    parser.add_argument('--cls-num', default=1000, type=int,
    ...
    parser.add_argument('--lamda',             default=0,      type=float,        help='weight for metric loss')
